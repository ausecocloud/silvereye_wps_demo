...
class MeanOneYearAllMonths(Process):
    def __init__(self):
        inputs = [
            LiteralInput(
        ...
        super(MeanOneYearAllMonths, self).__init__(
            self._handler,
            identifier='mean_one_year_all_months',
            title='ANUClim means for one year one month.',
    ...
    def _handler(self, request, response):
        ...
        worker.process_one_year_all_months(out_csv,
                                           year,
                                           (lat_min, lat_max),
                                           (lon_min, lon_max))
