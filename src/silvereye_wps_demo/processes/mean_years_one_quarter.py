...
class MeanYearsOneQuarter(Process):
    def __init__(self):
        inputs = [
            LiteralInput(
            ...
            LiteralInput(
                ...
                data_type='integer', min_occurs=1, max_occurs=1,
                mode=MODE.SIMPLE, allowed_values=[[1, 4]]
            ),
            LiteralInput(
        ...
        super(MeanYearsOneQuarter, self).__init__(
            self._handler,
            identifier='mean_years_one_quarter',
            title='ANUClim quarterly means for one quarter in a range of years.',
    ...
    def _handler(self, request, response):
        ...
        qtr = request.inputs["quarter"][0].data
